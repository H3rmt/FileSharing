...
FROM --platform=$BUILDPLATFORM node:alpine@sha256:dbaa92e5758cbbcf85d65d5403fdb530fe3442cbe8c6dbfb7ef23365450d5070 AS js-base
ENV PNPM_HOME="/pnpm"
...
FROM node:alpine@sha256:dbaa92e5758cbbcf85d65d5403fdb530fe3442cbe8c6dbfb7ef23365450d5070 AS run
WORKDIR /app
